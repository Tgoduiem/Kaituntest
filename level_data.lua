...
function Data.CheckLevel()
	...
	if Sea1 then
		...
		elseif Lv == 375 or Lv <= 399 or SelectMonster == "Fishman Warrior [Lv. 375]" or SelectArea == 'Fishman' then -- Fishman Warrior
			...
			if Auto_Farm and (CFrameMon.Position - Client.Character.HumanoidRootPart.Position).Magnitude > 3000 then
	...
	if Sea2 then
		...
		elseif Lv == 1250 or Lv <= 1274 or SelectMonster == "Ship Deckhand [Lv. 1250]" or SelectArea == 'Ship' then -- Ship Deckhand
			...
			if Auto_Farm and (CFrameMon.Position - Client.Character.HumanoidRootPart.Position).Magnitude > 20000 then
				ReplicatedStorage.Remotes.CommF_:InvokeServer("requestEntrance",
